...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = $con->query("INSERT INTO tbuser (name,gender,address,telephone,email,username,password,
    statusid,picture) values ('" . $name . "','" . $gender . "','" . $address . "','" . $telephone . "','" . $email . "','" . $username . "','" . $password . "','" . $statusid . "','" . $picture . "')");
    if ($sql) {
